...
高分词汇挖掘——雅思口语同义词：
`{apiAddress}/chat_completion.ChatService/ielts_speaking_words_synonyms`

高分词汇挖掘——雅思口语习语：
`{apiAddress}/chat_completion.ChatService/ielts_speaking_words_usage`

高分词汇挖掘——雅思写作主题词：
`{apiAddress}/chat_completion.ChatService/ielts_writing_words_theme`

高分词汇挖掘——雅思写作同义词：
`{apiAddress}/chat_completion.ChatService/ielts_writing_words_synonyms`

高分词汇挖掘——雅思写作词搭：
`{apiAddress}/chat_completion.ChatService/ielts_writing_words_combination`
